...
\section{Le stage}
	...
	De plus, un avantage majeur d'AngularJS comparé aux autres frameworks, est le fait qu'il ait été conçu avec les tests en tête. Il fournit de nombreuses aides pour tests son code, allant même jusqu'à proposer une libraire de tests d'intégration, chose inédite dans l'écosystème Javascript.
