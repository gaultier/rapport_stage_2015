...
\section{Mon stage}
	...
	\subsection{Outils utilisés}
		...
		\subsubsection{Bibliothèques utilisés}
		  ...
		  \begin{description}
		   \item [OpenGL] ~\\
		      <<Open Graphics Library>> est une API multi-plateforme pour effectuer des rendus graphiques 2D et 3D.
		   ...
		   \item [GLEW]~\\
		      <<OpenGL Extension Wrangler Library>> est une bibliothèque multi-plateforme de chargement des fonctionnalités d'OpenGL.
