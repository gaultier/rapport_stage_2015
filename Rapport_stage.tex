...
\section{Mon stage}
		...
		\subsubsection{Bibliothèques utilisés}
		  ...
		  \begin{description}
		   ...
		   \item [GLUT]~\\
		      ...
		      \url{http://freeglut.sourceforge.net/} et \url{http://www.opengl.org/resources/libraries/glut/}
		   \item [Octree]~\\
	...
	\subsection{Développement}
	  ...
	  \subsubsection{Design Patterns}
		...
		nuls, sans savoir lesquels à l'avance. Plutôt que d'écrire des dizaine de conditions pour vérifier si l'on peut bien effectuer telle ou telle action
	    ...
	    \item [Flyweight Pattern]~\\
	       ...
	       On choisit alors de charger cette resource au démarrage du programme. On lit une et une seule fois le fichier.
	    ...
	    \item [Factory pattern]~\\
	      ...
	      qui cherche d'abord à savoir si cet objet existe déjà.
	      
	      Dans mon cas, je l'ai utilisé pour implémenter le groupe de textures partagées. En effet lorsqu'un nouvel
	      objet graphique texturé est créé il fait une requête auprès de la fabrique de textures pour obtenir sa texture. La fabrique vérifie si la texture existe déjà en mémoire.
	    ...
	    \item [Data Locality]~\\
	       ...
	       Un autre point à considérer est la différence entre l'usage , dans une structure de donnée, du polymorphisme (plusieurs objets
	       différents coexistent, héritant d'un objet commun) et l'usage d'un seul type d'objets.
	       ...
	       Un dernier point à envisager est la différence de stockage des variables entre l'usage de pointeur sur variable
	       et l'usage de variables. Dans le premier cas, les variables sont allouées (et libérées) manuellement et sont placées sur
	       ...
	       La fragmentation est l'utilisation inefficace de l'espace mémoire. C'est un phénomène qui se produit lorsque sont effectuées de multiples allocations et
  ...
  \subsection{Améliorations}		
	...
	On ne remarque cependant pas de différence majeure de performances entre ces deux structures de données.
